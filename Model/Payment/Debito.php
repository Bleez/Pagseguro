...
class Debito extends \Magento\Payment\Model\Method\AbstractMethod
{
    protected $_code = 'pagseguro_debito';
...
//            unset($data['additional_data']);
        ...
        $infoInstance->setAdditionalInformation('banco', $data->getData('banco'));
    ...
    public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        $directPaymentRequest->setOnlineDebit(
            array(
                "bankName" => strtoupper($payment->getAdditionalInformation('banco'))
            )
        );
        ...
        try{
            ...
            $this->_checkoutSession->setData('pagSeguroDebito', $return->getPaymentLink());
